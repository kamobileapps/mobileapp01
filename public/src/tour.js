...
.config(function($stateProvider, $locationProvider, $urlRouterProvider) {
	...
	controller:'formController',
        ...
        views: {
          ...
          templateUrl: 'form-containerfour.html'
	  ...
	  .state('status.bar', {
        url: '/bar',
          ...
          templateUrl: 'form-containerfive.html'
	  ...
	  .state('status.bartwo', {
        url: '/bartwo',
          ...
          templateUrl: 'form-containersix.html'
         
        
      })
	   .state('status.barthree', {
        url: '/barthree',
		
   
               
          templateUrl: 'form-containerseven.html'
